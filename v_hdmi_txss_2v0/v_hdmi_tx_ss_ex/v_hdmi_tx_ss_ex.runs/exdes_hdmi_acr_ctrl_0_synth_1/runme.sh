...
HD_PWD='E:/xilinx_axi/v_dma_txss/v_hdmi_tx_ss_ex/v_hdmi_tx_ss_ex.runs/exdes_hdmi_acr_ctrl_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exdes_hdmi_acr_ctrl_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exdes_hdmi_acr_ctrl_0.tcl
