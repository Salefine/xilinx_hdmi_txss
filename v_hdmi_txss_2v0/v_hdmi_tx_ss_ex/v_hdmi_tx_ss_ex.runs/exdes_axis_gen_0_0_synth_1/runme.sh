...
HD_PWD='E:/xilinx_axi/mian/xilinx_hdmi_txss/v_hdmi_txss_2v0/v_hdmi_tx_ss_ex/v_hdmi_tx_ss_ex.runs/exdes_axis_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exdes_axis_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exdes_axis_gen_0_0.tcl
