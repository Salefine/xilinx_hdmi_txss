...
HD_PWD='E:/xilinx_axi/v_dma_txss/v_hdmi_tx_ss_ex/v_hdmi_tx_ss_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exdes_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exdes_wrapper.tcl -notrace
