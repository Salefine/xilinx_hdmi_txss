...
HD_PWD='E:/xilinx_axi/v_dma_txss/v_hdmi_tx_ss_ex/v_hdmi_tx_ss_ex.runs/bd_3ea7_v_tc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_3ea7_v_tc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_3ea7_v_tc_0.tcl
