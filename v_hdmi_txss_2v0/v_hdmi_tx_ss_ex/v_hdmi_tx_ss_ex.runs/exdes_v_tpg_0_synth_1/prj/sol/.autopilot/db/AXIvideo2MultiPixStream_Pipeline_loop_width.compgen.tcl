...
set id 11
set name exdes_v_tpg_0_mux_2568_8_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_V_5 \
    op interface \
    ports { axi_data_V_5 { I 48 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_icmp_ln835 \
    op interface \
    ports { icmp_ln835 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_srcYUV \
    op interface \
    ports { srcYUV_din { O 48 vector } srcYUV_num_data_valid { I 5 vector } srcYUV_fifo_cap { I 5 vector } srcYUV_full_n { I 1 bit } srcYUV_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 29 \
    name axi_data_V_6_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_V_6_out \
    op interface \
    ports { axi_data_V_6_out { O 48 vector } axi_data_V_6_out_ap_vld { O 1 bit } } \
} "
}
