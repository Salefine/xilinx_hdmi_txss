...
module aud_pat_gen_v1_0_0_dport
...
wire aud_config_update_pedge = (aud_config_update_sync[2]==1'b0 && aud_config_update_sync[1]==1'b1);
    ...
    PULSE_SYNC_INST
    (
        .SRC_RST_IN       (aud_reset),              // Source reset
        ...
        .SRC_DAT_IN       (pulse),    // Data in
        .DST_DAT_OUT      (pulse_sync_axis)         // Data out
	);

    aud_pat_gen_v1_0_0_lib_pls_cdc
    AUD_CONFIG_UPDATE_SYNC_INST
    (
        .SRC_RST_IN       (aud_reset),              // Source reset
        .SRC_CLK_IN       (aud_clk),              // Source clock
        .SRC_CKE_IN       (1'b1),              // Source clock
        ...
        .DST_CLK_IN       (axis_clk),              // Destination clock
        .DST_CKE_IN       (1'b1),              // Source clock
        .SRC_DAT_IN       (aud_config_update_pedge),    // Data in
        .DST_DAT_OUT      (load_value)         // Data out
	);
...
always@(posedge axis_clk) begin
  if(~axis_resetn || ~axis_start) begin
